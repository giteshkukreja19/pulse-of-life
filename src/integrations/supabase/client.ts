...
supabase.channel('system').on('system', { event: 'connection_status' }, (status) => {
  if (status.payload.status === 'connected') {
    console.log("Supabase connection successful!");
  } else if (status.payload.status === 'disconnected') {
...
// Add a utility function to help with handling Supabase errors
